...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1447,0,400,400],[1447,402,400,400],[0,518,400,400],[402,518,400,400],[804,587,400,400],[0,920,400,400],[402,920,400,400],[0,1322,400,400],[402,1322,400,400],[1206,804,400,400],[804,989,400,400],[868,0,577,585],[0,0,866,516]]},
		{name:"index_atlas_2", frames: [[0,0,1748,1858]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-83,-6,0.0873,0.0873);
	...
	this.text.setTransform(-14.743,150.55,0.8928,0.8928);
	...
	this.text_1.setTransform(-0.793,-94.9,0.8928,0.8928);
	if(!lib.properties.webfonts['Passion One']) {
		lib.webFontTxtInst['Passion One'] = lib.webFontTxtInst['Passion One'] || [];
...
p.nominalBounds = new cjs.Rectangle(-342.7,-96.7,669.9,299.8);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#BACF00").s().p("A+rHXQiKAAAAiJIAAqbQAAiJCKAAMA9XAAAQCKAAAACJIAAKbQAACJiKAAg");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AuwHXQiJAAAAiJIAAqbQAAiJCJAAIdgAAQCKAAAACJIAAKbQAACJiKAAg");
...
p.nominalBounds = new cjs.Rectangle(-375.2,-105.8,733.4,328.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(314,187,0.3851,0.3851);

	this.text = new cjs.Text("URBAN MOBILITY", "bold 71px 'Century Gothic'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 88;
	this.text.lineWidth = 750;
	this.text.parent = this;
	this.text.setTransform(497.95,14.9);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#BACF00").s().p("EhSUAunMAAAhdNMCkpAAAMAAABdNg");
	this.shape.setTransform(495.775,243);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.playButton},{t:this.text},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.MenuScreen, new cjs.Rectangle(-31.1,-55.2,1053.8,596.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.menuButton.setTransform(487.9,387.7,0.668,0.668,0,0,0,0.1,0.1);
...
}).prototype = getMCSymbolPrototype(lib.LoseScreen, new cjs.Rectangle(339.8,140.8,280.8,357.8), null);
...
}).prototype = getMCSymbolPrototype(lib.WinScreen, new cjs.Rectangle(337.1,142.5,286.29999999999995,383.6), null);
...
p.nominalBounds = new cjs.Rectangle(448.9,214.8,573.8000000000001,326.49999999999994);
// library properties:
lib.properties = {
